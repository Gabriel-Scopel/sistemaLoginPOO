...
if(isset($_POST['nome']) && isset ($_POST['email']) && isset($_POST['senha']) && isset($_POST['repete_senha'])){
    ...
    if(empty($nome) or empty($email) or empty($senha) or empty($repete_senha) or empty($_POST['termos'])){
        $termo_geral = "todos os campos são obrigatórios!";
    }else{
...
<body>
    <form method="POST">
        ...
        <div class="input-group">
            ...
            <div class="erro"><?php if (isset($usuario->erro["erro_nome"])){ $usuario->erro["erro_nome"];}?></div>
        </div>
        ...
        <div class="input-group">
            ...
            <div class="erro"><?php if (isset($usuario->erro["erro_email"])){ $usuario->erro["erro_email"];}?></div>
        </div>
        ...
        <div class="input-group">
            ...
            <div class="erro"><?php if (isset($usuario->erro["erro_senha"])){ $usuario->erro["erro_senha"];}?></div>
        </div>
        ...
        <div class="input-group">
            ...
            <div class="erro"><?php if (isset($usuario->erro["erro_repete"])){ $usuario->erro["erro_repete"];}?></div>
        </div>   
        
        <div <?php if(isset($erro_gerla) && $erro_geral == "todos os campos são obrigatórios!"){echo 'class="input-group erro-input"';}else{echo 'class="input-group" ';}?>>
